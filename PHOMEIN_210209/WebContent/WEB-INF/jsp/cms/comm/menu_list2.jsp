...
<html lang="ko">
<head>
<title>메뉴관리 | 공통관리 | 포메인 통합관리자</title>
...
<div id="wrap">
	...
	<section id="dBody">
		...
		<section id="contents">
			...
			<!-- //location -->
			<h3 class="con-title">메뉴 관리 / 하위메뉴</h3>
			
			<form name="searchForm" id="searchForm" action="menu_list2.do">
			...
			<form:form modelAttribute="menu" id="modifyForm">
				...
				<div class="table-list-data">
					<fieldset>
						<legend>메뉴 관리 검색 입력 폼</legend>
						<table class="view">
							<caption>메뉴 관리 검색 기본정보 입력 폼 테이블</caption>
							<colgroup>
							...
							<tbody>
								...
								<tr>
									<th scope="row">하위메뉴코드 <span class="need"></span></th>
									<td>
										<input type="text" name="sub_code" id="sub_code" maxlength="6" placeholder="하위메뉴코드를 입력하세요" style="width:100%">
									</td>
								</tr>
								<tr>
									<th scope="row">하위메뉴명 <span class="need"></span></th>
									<td>
										<input type="text" name="sub_code_name" id="sub_code_name" placeholder="하위메뉴명을 입력하세요" style="width:100%">
									</td>
								</tr>
								<tr>
									<th scope="row">하위메뉴링크 <span class="need"></span></th>
									<td>
										<input type="text" name="link" id="link" placeholder="하위메뉴링크를 입력하세요" style="width:100%">
									</td>
								</tr>
								<tr>
					...
					<table class="list" id="code_table">
						...
						<thead>
							<tr>
								...
								<th scope="col">하위메뉴코드</th>
								<th scope="col">하위메뉴명</th>
								<th scope="col">하위메뉴링크</th>
						...
						<c:choose>
							...
							<tr>
								...
								<td>${result.p_code }</td>
								<td class="al-l"><a href="#" class="btn-link">${result.p_name }</a></td>
								<td class="al-l"><a href="#" class="btn-link">${result.code }</a></td>
								<td class="al-l"><a href="#" class="btn-link">${result.menu_name }</a></td>
								<td class="al-l"><a href="#" class="btn-link">${result.link }</a></td>
								<td>
								...
								<td>
									<div class="table-btns row">
										<p><a href="javascript:;" data-seq="${result.seq }" data-useyn="${result.useyn }" data-code="${result.code }" data-code_name="${result.menu_name }" data-link="${result.link }" data-ordr="${result.ordr }" class="btn-01 type-02 round modifyBtn">수정</a></p>
							...
							<tr>
								<td>02</td>
								<td class="al-l"><a href="#" class="btn-link">매장 관리</a></td>
								<td class="al-l"><a href="#" class="btn-link">매장 관리</a></td>
								<td class="al-l"><a href="#" class="btn-link">http://www.~</a></td>
								<td>
									<div class="table-btns row">
							...
							<tr>
								<td>03</td>
								<td class="al-l"><a href="#" class="btn-link">게시판 관리</a></td>
								<td class="al-l"><a href="#" class="btn-link">공지&언론보도</a></td>
								<td class="al-l"><a href="#" class="btn-link">http://www.~</a></td>
								<td>
									<div class="table-btns row">
										<p><a href="#" class="btn-up">위로</a></p>
							...
							<tr>
								<td>03</td>
								<td class="al-l"><a href="#" class="btn-link">게시판 관리</a></td>
								<td class="al-l"><a href="#" class="btn-link">이벤트</a></td>
								<td class="al-l"><a href="#" class="btn-link">http://www.~</a></td>
								<td>
									<div class="table-btns row">
										<p><a href="#" class="btn-up">위로</a></p>
							...
							<tr>
								<td>03</td>
								<td class="al-l"><a href="#" class="btn-link">게시판 관리</a></td>
								<td class="al-l"><a href="#" class="btn-link">포메인 SNS</a></td>
								<td class="al-l"><a href="#" class="btn-link">http://www.~</a></td>
								<td>
									<div class="table-btns row">
										<p><a href="#" class="btn-up">위로</a></p>
							...
							<tr>
								<td>04</td>
								<td class="al-l"><a href="#" class="btn-link">문의 관리</a></td>
								<td class="al-l"><a href="#" class="btn-link">고객의 소리</a></td>
								<td class="al-l"><a href="#" class="btn-link">http://www.~</a></td>
								<td>
									<div class="table-btns row">
										<p><a href="#" class="btn-up">위로</a></p>
							...
							<tr>
								<td>04</td>
								<td class="al-l"><a href="#" class="btn-link">문의 관리</a></td>
								<td class="al-l"><a href="#" class="btn-link">가맹점 문의</a></td>
								<td class="al-l"><a href="#" class="btn-link">http://www.~</a></td>
								<td>
									<div class="table-btns row">
										<p><a href="#" class="btn-up">위로</a></p>
							...
							<tr>
								<td>04</td>
								<td class="al-l"><a href="#" class="btn-link">문의 관리</a></td>
								<td class="al-l"><a href="#" class="btn-link">포인트 병합 신청</a></td>
								<td class="al-l"><a href="#" class="btn-link">http://www.~</a></td>
								<td>
									<div class="table-btns row">
										<p><a href="#" class="btn-up">위로</a></p>
							...
							<tr>
								<td>04</td>
								<td class="al-l"><a href="#" class="btn-link">문의 관리</a></td>
								<td class="al-l"><a href="#" class="btn-link">10상품권 신청</a></td>
								<td class="al-l"><a href="#" class="btn-link">http://www.~</a></td>
								<td>
									<div class="table-btns row">
										<p><a href="#" class="btn-up">위로</a></p>
...
$(function(){
	...
	var message = {
		...
		sub_code: {
	        required: '하위메뉴코드를 입력하세요',
	        maxlength: '하위메뉴코드는 6자리 입니다'
	    },
	    sub_code_name: {
	        required: '하위메뉴명을 입력하세요'
	    },
	    link: {
	        required: '하위메뉴링크를 입력하세요'
	    }
	};
            ...
            success: function (data) {
            	...
            	if(!!data.result) {
            		if(data.result == 'SUCCESS') {
            			alert('정상적으로 등록되었습니다.');
            			location.href="/admin/comm/menu_list2.do?useyn=" + useyn + "&code=" + sub_code + "&pcode=" + $("#pcode").val() + "&link=" + $("#link").val() + "&code_name=" + sub_code_name + "&code_type=sub_code&type=udt";
            		} else {
	...
	$("#sortingBtn").on("click", function(){
	    ...
	    $.ajax({
            url: "/admin/comm/update_sorting_menu.do",
            type: "POST",
            data: {
