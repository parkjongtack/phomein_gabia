...
<div id="wrap">
	...
	<section id="dBody">
		<!-- lnb -->
		<%-- <%@ include file="/WEB-INF/jsp/include/lnb.jspf"%> --%>
		...
		<section id="contents">
			...
			<!-- //location -->
			<h3 class="con-title">메뉴 관리 / 상위메뉴</h3>
			
			<form name="searchForm" id="searchForm" action="menu_list.do">
					...
					<fieldset>
						...
						<table class="view">
							...
							<tbody>
								...
								<tr>
									<th scope="row">상위메뉴코드 <span class="need"></span></th>
									<td>
										<input type="text" name="code" id="code" maxlength="3" placeholder="상위메뉴코드를 입력하세요" style="width:100%">
									</td>
								</tr>
								<tr>
									<th scope="row">상위메뉴명 <span class="need"></span></th>
									<td>
										<input type="text" name="code_name" id="code_name" placeholder="상위메뉴명을 입력하세요" style="width:100%">
									</td>
								</tr>
								<tr>
									<th scope="row">상위메뉴링크 <span class="need"></span></th>
									<td>
										<input type="text" name="link" id="link" placeholder="상위메뉴링크를 입력하세요" style="width:100%">
									</td>
								</tr>
								<tr>
					...
					<table class="list" id="code_table">
						...
						<thead>
							<tr>
								...
								<th scope="col">상위메뉴링크</th>
								<th scope="col">정렬순서</th>
								<th scope="col">사용여부</th>
								<th scope="col">관리</th>
								<th scope="col">하위메뉴관리</th>
							</tr>
						</thead>
						<tbody>
							<c:choose>
								...
								<tr>
									...
									<td>
										<div class="table-btns row">
											<p><a href="/admin/comm/menu_list2.do?code=${result.code }&pcode=${result.code }&useyn=${result.useyn }&code_type=sub_code" class="btn-01 type-03 round">확인/등록</a></p>
										</div>
									</td>
								</tr>
							</c:forEach>
							...
							<tr>
								<td>05</td>
								<td class="al-l"><a href="#" class="btn-link">인트라넷</a></td>
								<td class="al-l"><a href="#" class="btn-link">http://www.~</a></td>
								<td>
									<div class="table-btns row">
										<p><a href="#" class="btn-up">위로</a></p>
							...
							<tr>
								<td>06</td>
								<td class="al-l"><a href="#" class="btn-link">회원 관리</a></td>
								<td class="al-l"><a href="#" class="btn-link">http://www.~</a></td>
								<td>
									<div class="table-btns row">
										<p><a href="#" class="btn-up">위로</a></p>
							...
							<tr>
								<td>07</td>
								<td class="al-l"><a href="#" class="btn-link">사이트 관리</a></td>
								<td class="al-l"><a href="#" class="btn-link">http://www.~</a></td>
								<td>
									<div class="table-btns row">
										<p><a href="#" class="btn-up">위로</a></p>
							...
							<tr>
								<td>08</td>
								<td class="al-l"><a href="#" class="btn-link">통계</a></td>
								<td class="al-l"><a href="#" class="btn-link">http://www.~</a></td>
								<td>
									<div class="table-btns row">
										<p><a href="#" class="btn-up">위로</a></p>
							...
							<tr>
								<td>09</td>
								<td class="al-l"><a href="#" class="btn-link">공동 관리</a></td>
								<td class="al-l"><a href="#" class="btn-link">http://www.~</a></td>
								<td>
									<div class="table-btns row">
										<p><a href="#" class="btn-up">위로</a></p>
							...
							<tr>
								<td>10</td>
								<td class="al-l"><a href="#" class="btn-link">광고 관리</a></td>
								<td class="al-l"><a href="#" class="btn-link">http://www.~</a></td>
								<td>
									<div class="table-btns row">
										<p><a href="#" class="btn-up">위로</a></p>
...
$(function(){
	...
	var message = {
		...
		code: {
	        required: '상위메뉴코드를 입력하세요',
	        maxlength: '상위메뉴코드는 3자리 입니다'
	    },
	    code_name: {
	        required: '상위메뉴명을 입력하세요'
	    },
	    link: {
	        required: '상위메뉴링크를 입력하세요'
	    }
	};
            ...
            success: function (data) {
            	...
            	if(!!data.result) {
            		if(data.result == 'SUCCESS') {
            			alert('정상적으로 등록되었습니다.');
            			location.href="/admin/comm/menu_list2.do?useyn=" + useyn + "&code=" + sub_code + "&pcode=" + $("#pcode").val() + "&code_name=" + sub_code_name + "&link=" + link + "&code_type=sub_code&type=udt";
            		} else {
