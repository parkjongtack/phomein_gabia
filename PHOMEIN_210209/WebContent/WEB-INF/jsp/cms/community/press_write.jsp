...
<html lang="ko">
<head>
<title>공지&언론보도 등록 | 커뮤니티 | 포메인 통합 관리</title>
	...
	<section id="dBody">
		...
		<section id="contents">
			...
			<div class="default-cell">
				<h4 class="sub-title">공지&언론보도 등록<span class="fc01">* 는 필수입력/선택 항목입니다</span></h4>

				<div class="table-list-data">
					<fieldset>
						<legend>공지&언론보도 등록 기본정보 입력 폼</legend>
						<table class="view">
							<caption>공지&언론보도 등록 기본정보 입력 폼 테이블</caption>
							<colgroup>
