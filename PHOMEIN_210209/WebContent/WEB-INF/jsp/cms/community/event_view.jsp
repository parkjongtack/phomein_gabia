...
<div id="wrap">
	...
	<section id="dBody">
		...
		<section id="contents">
			...
			<h3 class="con-title border">이벤트</h3>

			<div class="default-cell">
				<h4 class="sub-title">이벤트 상세/수정<span class="fc01">* 는 필수입력/선택 항목입니다</span></h4>

				<div class="table-list-data">
					<fieldset>
						<legend>이벤트 상세/수정 기본정보 입력 폼</legend>
						<table class="view">
							<caption>이벤트 상세/수정 기본정보 입력 폼 테이블</caption>
							<colgroup>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<div class="mulity-check-radio">
											<div><p class="radio-type01"><input type="radio" id="radio0201" name="radio02" checked><label for="radio0201"><span></span>매장이벤트</label></p></div>
											<div><p class="radio-type01"><input type="radio" id="radio0202" name="radio02"><label for="radio0202"><span></span>공식이벤트</label></p></div>
										</div>
									</td>
								</tr>
								<tr>
									...
									<td>
										<p class="input-btns"><input type="text" name="" id="" style="width:250px" value="천안불당점" readonly><a href="#" class="btn-01 type-03 round">매장 검색</a></p>
									</td>
								</tr>
								<tr>
									<th scope="row">제목 <span class="need"></span></th>
									<td>
										<input type="text" name="" id="" value="영화 <국가부도의 날> 관람 초대 이벤트 " style="width:100%">
									</td>
								</tr>
								<tr>
									...
									<td>
										<div class="date-input-wrap">
											<div class="cell"><p class="date-input"><input type="text" name="" id="" class="datepicker" style="width:130px;" value="2018-11-05"></p></div>
											<div class="cell"><p class="date-input"><input type="text" name="" id="" class="datepicker" style="width:130px;" value="2018-11-25"></p></div>
										</div>
									</td>
								</tr>
								<tr>
									...
									<td>
										<div class="mulity-check-radio">
											<div><p class="radio-type01"><input type="radio" id="radio0201" name="radio02" checked><label for="radio0201"><span></span>진행중</label></p></div>
											<div><p class="radio-type01"><input type="radio" id="radio0202" name="radio02"><label for="radio0202"><span></span>종료</label></p></div>
										</div>
									</td>
								</tr>
								<tr>
