	...
	<section id="dBody">
		...
		<section id="contents">
			...
			<div class="default-cell">
				<h4 class="sub-title">포메인 SNS 상세/수정<span class="fc01">* 는 필수입력/선택 항목입니다</span></h4>

				<div class="table-list-data">
					<fieldset>
						<legend>공지사항 상세/수정 기본정보 입력 폼</legend>
						<table class="view">
							<caption>공지사항 상세/수정 기본정보 입력 폼 테이블</caption>
							<colgroup>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<input type="text" name="" id="" value="제목" style="width:100%">
									</td>
								</tr>
								<tr>
