					...
					<fieldset>
						...
						<table class="view">
							...
							<tbody>
								...
								<tr>
									<th scope="row" style="background:#FCD9DB">설정<span class="need"></span></th>
									<td>
										<div class="mulity-check-radio">
								...
								<tr>
									<th scope="row" style="background:#FCD9DB">(대)제품사진<br><em class="fc01">(사이즈 x 사이즈)</em><span class="need"></span></th>
									<td>
								...
								<tr>
									<th scope="row" style="background:#FCD9DB">(중)제품사진<br><em class="fc01">(사이즈 x 사이즈)</em><span class="need"></span></th>
									<td>
										<ul class="file-parent" style="width:700px">
											<li class="add-input">
												<div class="add-file">
								...
								<tr>
									<th scope="row" style="background:#FCD9DB">(소)제품사진<br><em class="fc01">(사이즈 x 사이즈)</em><span class="need"></span></th>
									<td>
										<ul class="file-parent" style="width:700px">
											<li class="add-input">
												<div class="add-file">
								...
								<tr>
									<th scope="row" style="background:#FCD9DB">첨부파일<br><em class="fc01">(사이즈 x 사이즈)</em><br>(최대 5개 가능)</th>
									<td>
										<ul class="file-parent" style="width:700px">
											<li class="add-input">
												<div class="add-file">
								...
								<tr>
									<th scope="row" style="background:#FCD9DB">작성</th>
									<td>admin1234</td>
								</tr>
							</tbody>
						</table>
