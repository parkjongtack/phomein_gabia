	...
	<section id="dBody">
		...
		<section id="contents">
			...
			<div class="default-cell">
				<h4 class="sub-title">디자인 발주 신청 관리 상세/수정<span class="fc01">* 는 필수입력/선택 항목입니다</span></h4>

				<div class="table-list-data">
					<fieldset>
						<legend>디자인 발주 신청 관리 상세/수정 기본정보 입력 폼</legend>
						<table class="view">
							<caption>디자인 발주 신청 관리 상세/수정 기본정보 입력 폼 테이블</caption>
							<colgroup>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<%-- <c:choose>
											<c:when test="${fileresult.filename5 == '' || fileresult.filename5 == null }"><c:set var="fl" value="4"/></c:when>
											<c:when test="${fileresult.filename4 == '' || fileresult.filename4 == null }"><c:set var="fl" value="3"/></c:when>
											<c:when test="${fileresult.filename3 == '' || fileresult.filename3 == null }"><c:set var="fl" value="2"/></c:when>
											<c:when test="${fileresult.filename2 == '' || fileresult.filename2 == null }"><c:set var="fl" value="1"/></c:when>
											<c:when test="${fileresult.filename1 == '' || fileresult.filename1 == null }"><c:set var="fl" value="0"/></c:when>
										</c:choose> --%>
								...
								<tr>
									...
									<td>
										<div class="mulity-check-radio">
											<div><p class="radio-type01"><input type="radio" id="radio0201" name="priceuse" value="Y" onclick="fnPrice('Y')" <c:if test="${result.priceuse == 'Y' }"> checked </c:if>><label for="radio0201"><span></span>설정</label></p></div>
											<div><p class="radio-type01"><input type="radio" id="radio0202" name="priceuse" value="N" onclick="fnPrice('N')" <c:if test="${result.priceuse == 'N' }"> checked </c:if>><label for="radio0202"><span></span>미설정</label></p></div>
										</div>
									</td>
								</tr>
								<c:choose>
											...
											<li class="add-input">
												<div class="add-text">
													<div class="row-input-wrap"><input type="hidden" name="useq" id="useq" value="${ price.seq }"/>
														...
														<div><input type="text" name="price" id="price0" value="${ price.price }" style="width:100px" class="al-r"><span class="char">원</span></div>
													</div>
													<p class="btn-ui">
											...
											<li class="add-input">
												<div class="add-text">
													<div class="row-input-wrap"><input type="hidden" name="useq" id="useq" value="0"/>
														...
														<div><input type="text" name="price" id="price0" style="width:150px" class="al-r" onkeyup="fnOnlyNumber(this);"><span class="char">원</span></div>
													</div>
													<p class="btn-ui">
														<a href="javascript:;" onclick="front.form.addInputText(this);" class="btn-add"></a>
