...
<%@ include file="/WEB-INF/jsp/include/head.jspf"%>
	...
	// <![CDATA[  
		...
		function fnDeleteDesignOrder(seq) {
					...
					<table class="view">
						...
						<tbody>
							...
							<tr>
								<th scope="row">매장명</th>
								<td>
									<input type="text" name="storename" id="storename" placeholder="매장명을 입력하세요" value="${searchVO.storename }" style="width:100%" value="${ searchVO.storename }">
								</td>
							</tr>
							<tr>
								<th scope="row">상품명</th>
							...
							<tr style="display:none;">
								...
								<td>
									<input type="text" name="name" id="name" placeholder="입금자명을 입력하세요" value="${searchVO.name }" style="width:100%">
								</td>
							</tr>
						</tbody>
					</table>
					...
					<table class="list">
						...
						<c:choose>
							...
							<tr>
								...
								<td>
									<p>
										<a href="javascript:;" id="seq" name="seq" class="btn-02 type-03 round" onclick="fnDeleteDesignOrder(${ result.seq });">삭제</a>
									</p>
								</td>
							</tr>
							</c:forEach>
