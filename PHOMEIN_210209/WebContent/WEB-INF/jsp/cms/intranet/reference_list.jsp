...
<div id="wrap">
	...
	<section id="dBody">
		...
		<section id="contents">
			...
			<h3 class="con-title">자료실</h3>
			<form name="searchForm" id="searchForm" method="get" action="./reference_list.do">
				<input type="hidden" name="seq" value="${searchVO.seq}"/>
			...
			<div class="table-list-data">
				<fieldset>
					<legend>자료실 검색 입력 폼</legend>
					<table class="view">
						<caption>자료실 검색 기본정보 입력 폼 테이블</caption>
						<colgroup>
			...
			<div class="default-cell">
					...
					<table class="list">
						...
						<c:choose>
							...
							<tr>
								...
								<td class="fc01">[알림]</td>
								<td class="al-l">
									<a href="#" onclick="javascript:fnDetailView('reference_view.do', <c:out value="${result.seq }" />); return false;" class="btn-link">${fnc:xssContents(result.title )}</a>
								...
								<td>
									<div class="table-btns row">
										<p><a href="#" onclick="javascript:fnDetailView('./reference_view.do', <c:out value="${result.seq }" />); return false;" class="btn-01 type-02 round">수정</a></p>
						...
						<c:choose>
							...
							<tr>
								...
								<td class="al-l"><a href="#" onclick="javascript:fnDetailView('./reference_view.do', <c:out value="${result.seq }" />); return false;" class="btn-link">${fnc:xssContents(result.title )}</a></td>
								<td>
									<p class="table-date">
									<fmt:parseDate value="${result.regdt}" var="regDt" pattern='yyyy-MM-dd HH:mm:ss'/>
									<fmt:formatDate value="${regDt}" pattern='yyyy.MM.dd' var="regDttmp"/>
				...
				<div class="paging-wrap">
					...
					<p class="btn-pos-right">
						<a href="./reference_write.do" class="btn-01 type-01">등록</a>
					</p>
				</div>
			</div>
