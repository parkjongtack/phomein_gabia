	...
	<section id="dBody">
		...
		<section id="contents">
			...
			<div class="table-list-data">
				<fieldset>
					<legend>디자인 발주 신청 관리 검색 입력 폼</legend>
					<table class="view">
						<caption>디자인 발주 신청 관리 검색 기본정보 입력 폼 테이블</caption>
						<colgroup>
			...
			<div class="default-cell">
					...
					<table class="list">
						...
						<c:choose>
							...
							<tr>
								...
								<td class="al-l">
									<a href="#" onclick="javascript:fnDetailView('./order_design_manage_view.do', <c:out value="${result.seq }" />); return false;" class="btn-link">${fnc:xssContents(result.title )}</a>
								...
								<td>
									<div class="table-btns row">
										<p><a href="#" onclick="javascript:fnDetailView('./order_design_manage_view.do', <c:out value="${result.seq }" />); return false;" class="btn-01 type-02 round">수정</a></p>
				...
				<div class="paging-wrap">
					...
					<p class="btn-pos-right">
						<a href="./order_design_manage_write.do" class="btn-01 type-01">등록</a>
					</p>
				</div>
			</div>
		</section>
