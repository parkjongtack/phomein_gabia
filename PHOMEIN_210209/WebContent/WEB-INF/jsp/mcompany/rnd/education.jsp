		...
		<div id="content" class="rnd">
			<div class="education">
				<div class="tit_area">
					...
					<p class="desc">
						포메인은 신규 창업자 및 가맹점주들이 안정적인<br>
						매장 운영을 바탕으로 고객들에게 건강한 테이블을 전할 수 있도록 
						[분당 정자본점]에 동종업계 최초로 전문교육장을 마련하여 
						체계적인 커리큘럼에 따른 매장 운영 교육을 진행하고 있습니다.
					</p>
				</div>
				<div class="content">
					<h5>체계적인 교육,<br>15년의 노하우 전수</h5>
					<p class="txt">	
						㈜데일리킹 전문교육장에서는 메뉴 조리법은 물론<br> 식자재 및 주방 위생 관리법, 고객 응대 등<br>
