...
<div id="wrap">
		...
		<div id="content" class="store pd0"  style="width:100%;height:600px;">
			...
			<div class="store_search" style="z-index:20;">
				...
				<ul class="nav">
					...
					<li><a href="#none" onclick="layerOpen('layerStoreAddr');">ADDRESS</a></li>
					<li><a href="#none" onclick="layerOpen('layerStoreOption');">OPTIONS</a></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div id="layerStoreName" class="layer_pop" style="z-index:20001;">
		...
		<div class="cont">
			<div class="search_input">
				<input type="text" name="searchStoreName" id="searchStoreName" class="text" placeholder="NAME" title="매장명" value="${storeName }" onkeypress="if(event.keyCode==13) {searchStoreNameBtn();}">
			...
			<div class="search_result">
				<div class="result_option">
					<button type="button" class="btn_retry" onclick="searchStoreNameHiddenBtn();">RESET</button>
					<span class="num">RESULT <em id="totalCnt">0</em> </span>
				</div>
				<!-- 검색 결과 없을 때 -->
	...
	<div id="layerStoreAddr" class="layer_pop" style="z-index:20001;">
		...
		<div class="cont">
			<div class="search_input">
				<input type="text" class="text"  name="searchAddr" id="searchAddr" placeholder="ADDRESS" title="주소" onkeypress="if(event.keyCode==13) {searchAddrBtn();}">
			...
			<div class="search_result">
				<div class="result_option">
					<button type="button" class="btn_retry" onclick="searchAddrHiddenBtn();">RESET</button>
					<span class="num">RESULT <em id="totalAddrCnt">0</em> </span>
				</div>
				<!-- 검색 결과 없을 때 -->
		...
		<div class="cont">
			<div class="search_option">
				<ul>
					<li class="delivery">
						<span class="checkbox">
							<input type="checkbox" id="rd11" name="rd1" value="Y"><label for="rd11">DELIVERY</label>
						</span>
					</li>
					<li class="best">
						<span class="checkbox">
							<input type="checkbox" id="rd12" name="rd1" value="Y"><label for="rd12">BEST</label>
						</span>
					</li>
					<li class="parking">
						<span class="checkbox">
							<input type="checkbox" id="rd13" name="rd1" value="Y"><label for="rd13">PARKING</label>
						</span>
					</li>
				</ul>
			</div>
			...
			<div class="search_result">
				<div class="result_option">
					<button type="button" class="btn_retry" onclick="searchOptBtn();">RESET </button>
					<span class="num">RESULT <em id="totalOptCnt">0</em> </span>
				</div>
				<!-- 검색 결과 없을 때 -->
...
<script>
	...
	var store_init = function (storeName){
		$.ajax({
	     	url: "/meng/store/selectStoreList.do",
	        type: "POST",
	        data: {
	        	'en_name' : storeName,
	        	'useyn' : 1
