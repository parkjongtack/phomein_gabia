	...
	<div id="container">
		...
		<div id="content" class="community">
			...
			<div class="write_area">
				...
				<input type="hidden" name="cate" id="cate" value="110202"/>
				<table class="table_write">
						...
						<tbody>
					 		<tr>
								...
								<td><input type="text" name="title" id="title" class="text" placeholder="TITLE" title="TITLE"></td>
							</tr>
							<tr>
								<th scope="row"><strong class="ico_import">CONTENT</strong></th>
								<td><textarea name="conts" id="conts" class="text" cols="30" rows="5" placeholder="CONTENT" title="CONTENT"></textarea></td>
							</tr>
							<tr>
								<th scope="row"><strong class="ico_import">NAME</strong></th>
								<td><input type="text" name="name" id="name" class="text" placeholder="NAME" title="NAME"></td>
							</tr>
							<tr>
...
$(function(){
	...
	var submitFunction = function (form) {
	    ...
	    $.ajax({
            url: "/meng/community/cs_center_modify.do",
            type: "POST",
            data: formdata,
            ...
            success: function (data) {
            	...
            	if(!!data.result) {
            		if(data.result == 'SUCCESS') {
            			...
            			location.href="/meng/community/cs_terms.do";
            		}
            	}
