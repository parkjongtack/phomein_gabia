			...
			<div class="agree_area">
				<div class="agree_cont">
					...
					<p>
						...
						2. Purpose of collecting and using personal information: Consultation about customer's voice <br>
				...
				<span class="checkbox">
					<form name="submitForm" method="post" action="/meng/community/cs_info.do">
