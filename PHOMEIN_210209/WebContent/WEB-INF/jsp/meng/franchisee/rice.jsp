...
.red03-wrap h2{font-size: 19px; line-height: 34px; margin-bottom: 30px; font-weight: 400; color: #000;}
				...
				<div class="inner02">
					<div class="red01-wrap">
						<div class="red01-inner">
							<span>
								PhoMein, the No. 1 Korea’s representative pho brand, <br>thought that there should be a healthy<br>
								change in ‘noodles’ of pho as the <br>leader of the Vietnamese food culture.
								<br/>
								<br/>
								We have established ‘Pho Season’, a local factory <br> in Vietnam that manufactures rice noodles, to
								make  <br>healthy noodles instead of using an old rice or wheat. <br> We are provided with freshly
								harvested rice all year<br> around in Vietnam where triple cropping  <br>for a year is available.<br/>
								<br/>
								After numerous tests along with trial and error,<br> we successfully contained Freshly Harvested Rice’s<br>
								own taste, scent and texture in Pho noodles<br> only with fresh rice and purified water,<br>
								without chemical additives.<br/>
								<br/>
								Experience healthy and safe pho with your children<br> and your family at PhoMein that serves the
								unprecedent<br> noodles made with new crop rice of our <br>exclusive technology.<br/>
							</span>
						</div>
					</div>
					<div class="red02-wrap">
						...
						<ul class="box">
							<li>
								...
								<div class="text_box">
									<p>FRESH</p>
									<span>The fragrance of freshly cooked <br>rice using
											freshly harvested<br> new rice 365 days a year</span>
								</div>
							</li>
							<li>
								<div class="img_box">
								...
								<div class="text_box">
									<p>CLEAN</p>
									<span>The rice noodle contains clear and transparent
									color of new rice by<br> only using clean
									rice grain<br> and purified water</span>
								</div>
							</li>
							<li>
								<div class="img_box">
								...
								<div class="text_box">
									<p>TECHNOLOGY</p>
									<span>The unique machine drying and <br>
									low-temperature agingtechnology<br> completes
									a soft and chewy<br> texture.</span>
								</div>
							</li>
						</ul>
					</div>
					<div class="red03-wrap">
						<h2>
							PhoMein's "Noodle" is different,<br>
							it is a healthy <br>“Freshly Harvested Rice Noodles"<br>
							made by PhoMein's own technology.
						</h2>
