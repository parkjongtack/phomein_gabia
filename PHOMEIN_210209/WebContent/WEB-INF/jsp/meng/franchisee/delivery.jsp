			...
			<div class="inner02">
				<div class="red01-wrap">
					<div class="red01-inner">
						<span>
							PhoMein, a Vietnamese pho restaurant that practiced <br>the delivery service for the first time in 2014<br>
							in this field, started the delivery business<br> to establish an environment where anyone <br>can enjoy
							pho anytime and anywhere.<br/>
							<br/>
							It wasn’t easy at all, but PhoMein has successfully<br> settled in the rapidly growing delivery market<br>
							by building competitiveness with the package renewal<br> work through multiple test operations for<br>
							last 7 years and the delivery manual work.<br/>
							<br/>
							Now, many people jump into the pho market.<br>
							As the competitiveness of PhoMein hasn’t been<br> established in a day, we provide the<br>
							independently developed pho specialized package <br>and our own exclusive services.<br/>
							<br/>
							The taste of savory freshly cooked rice delivered<br>
							to you is the strength of PhoMein noticed by customers.<br/>
							<br/>
							Enjoy 32 Vietnamese dishes reinterpreted with <br> PhoMein’s exclusive recipe
							anytime and <br>anywhere like eating at the restaurant.<br/>
						</span>
					</div>
					<div class="red01-img">
