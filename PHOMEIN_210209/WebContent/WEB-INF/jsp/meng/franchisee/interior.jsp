		...
		<div id="content" class="franchisee">
			...
			<div class="interior">
				<div class="tit_area">
					...
					<p class="desc">
					On top of pursuing a simple & clean space by minimizing unnecessary elements,<br>
					Phomein also creates a comfortable mood for<br>
					mealtime with the use of bright & warm colors.
					</p>
				</div>
				<c:choose>
					...
					<a href="/meng/store/store_list.do?storeName=${result.en_name }&best=Y">
						<div class="swiper">
...
$("#moreBtn").on("click", function(){
	...
	$.ajax({
     	url: "/meng/franchisee/get_interior_list_ajax.do",
        type: "POST",
        data: {
...
<script id="interiorListTmpl" type="text/x-tmpl">
	...
	{{each(key,item) jsonArr}}
		<a href="/meng/store/store_list.do?storeName={{= item.en_name}}&best=Y">
		<div class="swiper">
			<ul class="swiper_wrap">
			{{if item.f_file6 != ""}}
