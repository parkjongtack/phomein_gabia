		...
		<div id="content" class="menu">
			...
			<div class="detail_menu">
				<div class="detail_head">
					<span class="flag">${resultView.en_code_name }</span>
					<span class="tit">${resultView.en_name }</span>
				</div>
				...
				<div class="detail_cont">
					<p class="txt">${resultView.en_menu }</p>
<!-- 
					...
					<p class="caution">Prices may vary by store</p>
 -->
				</div>
				<!-- 버튼 영역 -->
				<div class="btn_area">
					<a href="/meng/menu/red_menu_list.do" class="btn_tyf c_black">LIST</a>
				</div>
				<!-- //버튼 영역 -->
			</div>
			<!-- //상세 영역 -->
