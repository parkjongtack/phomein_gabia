	...
	<div id="container">
		...
		<div id="content" class="menu">
			<ul class="nav_cate_wrap">
				<li class="nav_cate_btn"><a href="/meng/menu/menu_list.do">PHOMAIN</a></li>
				<li class="nav_cate_btn on"><a href="/meng/menu/red_menu_list.do">PHOMAIN RED</a></li>
			</ul>
			...
			<div class="select_cate">
				...
				<span class="selectbox">
					...
					<select id="selCate">
						<option name="all" value="all" checked>ALL</option>
			...
			<div class="list_area">
				...
				<div class="nav_cate swiper">
					<ul class="nav_cate_wrap">
						<li class="nav_cate_btn on"><a href="javascript:;" name="menu_ck" data-code="all">ALL</a></li>
				...
				<ul class="list_menu">
					<c:choose>
						...
						<c:forEach items="${resultList }" var="result" varStatus="status" >
							<li>
								<a href="/meng/menu/red_menu_view.do?seq=${result.seq }" class="link_thum_list">
									<span class="thum">
									...
									<span class="txt">
										<span class="tit">${result.en_name }</span>
									</span>
								</a>
		 					</li>
		 				</c:forEach>
				...
				<c:if test="${totalRecordCount > pageIndex * 6}">
					<!-- 버튼 영역 -->
					<div class="btn_area">
						<button type="button" id="moreBtn" class="btn_tyf c_white btn_more">MORE</button>
					</div>
					<!-- //버튼 영역 -->
				</c:if>
				<div class="tackout">
					<img src="../common/images/content/tackout_service_m_1280x560.jpg" alt="">
				</div>
			</div>
			<!-- //리스트 영역 -->
...
var best_ck = "N";
	...
	$.ajax({
     	url: "/meng/menu/get_red_menu_list_ajax.do",
        type: "POST",
        data: {
...
<script id="menuListTmpl" type="text/x-tmpl">
	...
	{{each(key,item) jsonArr}}
		<li>
			<a href="/meng/menu/red_menu_view.do?pageIndex={{= item.pageIndex}}&seq={{= item.seq}}" class="link_thum_list">
				<span class="thum">
				...
				<span class="txt">
					<span class="tit">{{= item.en_name}}</span>
				</span>
			</a>
 		</li>
	{{/each}}
