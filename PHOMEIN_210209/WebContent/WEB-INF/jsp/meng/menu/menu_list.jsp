				...
				<ul class="list_menu">
					<c:choose>
						...
						<c:forEach items="${resultList }" var="result" varStatus="status" >
							<li>
								<a href="/meng/menu/menu_view.do?seq=${result.seq }" class="link_thum_list">
									<span class="thum">
...
var best_ck = "N";
	...
	$.ajax({
     	url: "/meng/menu/get_menu_list_ajax.do",
        type: "POST",
        data: {
...
<script id="menuListTmpl" type="text/x-tmpl">
	...
	{{each(key,item) jsonArr}}
		<li>
			<a href="/meng/menu/menu_view.do?pageIndex={{= item.pageIndex}}&seq={{= item.seq}}" class="link_thum_list">
				<span class="thum">
