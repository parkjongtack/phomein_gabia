				...
				<ul class="list_menu">
					<c:choose>
						...
						<c:forEach items="${resultList }" var="result" varStatus="status" >
							<li>
								<a href="/mbrand/menu/red_menu_view.do?seq=${result.seq }" class="link_thum_list">
									<span class="thum">
...
function makeMenuList(flag) {
	...
	$.ajax({
     	url: "/mbrand/menu/get_red_menu_list_ajax.do",
        type: "POST",
        data: {
...
<script id="menuListTmpl" type="text/x-tmpl">
	...
	{{each(key,item) jsonArr}}
		<li>
			<a href="/mbrand/menu/red_menu_view.do?pageIndex={{= item.pageIndex}}&seq={{= item.seq}}" class="link_thum_list">
				<span class="thum">
