<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
	<div class="lnb">
		<div class="dep dep1">
			...
			<ul class="dep_list">
				<li id="COMPANY"><a href="/mcompany/company/dailyking.do">COMPANY</a></li>
				<li id="BRAND"><a href="/mcompany/company/phomein.do">BRAND</a></li>
		...
		<div class="dep dep2" style="display:none;">
			...
			<ul class="dep_list">
				...
				<li style="display:none;"><a href="/mbrand/menu/menu_view.do">메뉴</a></li>
				<li style="display:none;"><a href="/mbrand/menu/red_menu_view.do">메뉴</a></li>
