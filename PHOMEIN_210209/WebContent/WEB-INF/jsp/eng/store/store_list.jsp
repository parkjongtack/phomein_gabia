...
<div id="wrap">
	...
	<section id="dBody" class="store no-visual">
		...
		<div class="page-title">
			<div class="visual" style="background-image:url('/eng/images/content/sub_visual_03.jpg');"></div>
			...
			<div class="map-wrap" center center no-repeat;background-size:cover"> <!-- style="background:url(../images/tmp/@map.jpg); -->
				...
				<div id="map">
					<div class="map-search-box">
						<h3 class="h3-type">FIND A STORE</h3>
						<div class="map-tab tabArea">
							<ul class="tab">
								<li class="active"><a href="#">NAME</a></li>
								<li id="addrLi"><a href="#">ADDRESS</a></li>
								<li id="optLi"><a href="#">OPTIONS</a></li>
							</ul>
							<!-- 매장명 -->
							<div class="tap-con on">
								...
								<div class="sch-input">
									<fieldset>
										...
										<input type="text" name="searchStoreName" id="searchStoreName" placeholder="STORE NAME" title="매장명 입력" value="${storeName }" onkeypress="if(event.keyCode==13) {searchStoreNameBtn();}">
								...
								<div class="store-list">
									<div class="result">
										<a href="javascript:void(0)" onclick="searchStoreNameHiddenBtn();" class="btn-sch">RESET</a>
										<span>RESULT <em id="totalCnt">0</em> </span>
									</div>
									<ul id="storeListNameUl">
										<li class="no-result">No information found</li>
									</ul>
								</div>
								<!-- //store-list -->
							</div>
							...
							<div class="tap-con">
								...
								<div class="sch-input">
									<fieldset>
										...
										<input type="text" name="searchAddr" id="searchAddr" placeholder="ADDRESS" title="주소를 입력" onkeypress="if(event.keyCode==13) {searchAddrBtn();}">
										<input type="hidden" name="searchAddrHidden" id="searchAddrHidden">
										<button type="button" class="btn" onclick="searchAddrBtn();"><span>검색</span></button>
									</fieldset>
								</div>
								<!-- //sch-input -->
								...
								<div class="store-list">
									<div class="result">
										<a href="javascript:void(0)" onclick="searchAddrHiddenBtn();" class="btn-sch">RESET</a>
										<span>RESULT <em id="totalAddrCnt">0</em> </span>
									</div>
							...
							<div class="tap-con">
								...
								<div class="store-list">
									<div class="result">
										<a href="javascript:void(0);"  onclick="searchOptBtn();" class="btn-sch">RESET</a>
										<span>RESULT <em id="totalOptCnt">0</em> </span>
									</div>
				...
				<script>
					...
					function initDaumApi(storeId , mapX , mapY){
					    ...
					    daum.maps.event.addListener(marker, 'click', function() {
					    	...
					    	$("#layerPopStore").load("/eng/store/store_view.do?seq="+storeId );
...
<script>
	...
	var store_init = function (storeName){
		$.ajax({
	     	url: "/eng/store/selectStoreList.do",
	        type: "POST",
	        data: {
	        	'en_name' : storeName,
	        	'useyn' : 1
	        ...
	        success: function (data) {
	    	    ...
	    	    if(data.resultList.length > 0) {
    				...
    				var $html = '';
    				$html += "<li class='no-result'>No information found</li>";
    				$('#storeListNameUl').append($html);
    				initDaumNoAddrApi();
    			}
