		...
		<div id="contents" class="content">
			<div class="interior-con">
				<div class="con-title">
					...
					<p class="txt">On top of pursuing a simple & clean space by minimizing unnecessary elements,<br> Phomein also creates a comfortable mood for mealtime with the use of bright & warm colors.</p>
					<!-- //20190225 수정 -->
				</div>
				<c:choose>
