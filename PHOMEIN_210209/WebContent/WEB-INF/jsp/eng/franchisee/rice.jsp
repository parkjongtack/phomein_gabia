...
.red04-inner .red04-left{width: 520px; height: 350px; float: left; background: url(/company/images/red/red04-bg01.jpg) center center no-repeat; background-size: 100% 100%;}
...
.red05-inner table tr td.td-bg p{font-size: 20px; width: 153px; height: 153px; line-height:153px; letter-spacing:0; font-weight: bold; color: #333; background: url(/company/images/red/red05-tbl-bg01.png) center center no-repeat; background-size: cover; margin: 0 auto;}
/* red05 */
...
.red02-wrap{background-image: url('/company/images/content/red02-wrap_bg.jpg'); height: 938px; margin-bottom: 320px;}
				...
				<div class="mt80">
					<div class="red01-wrap">
						<div class="red01-inner">
							<span>
								PhoMein, the No. 1 Korea’s representative pho brand, thought that there should be a healthy<br/>
								change in ‘noodles’ of pho as the leader of the Vietnamese food culture.<br/>
								<br/>
								We have established ‘Pho Season’, a local factory in Vietnam that manufactures rice noodles, to <br/>
								make healthy noodles instead of using an old rice or wheat. We are provided with freshly <br/>
								harvested rice all year around in Vietnam where triple cropping for a year is available. <br/>
								<br/>
								After numerous tests along with trial and error, we successfully contained Freshly Harvested Rice’s <br/>
								own taste, scent and texture in Pho noodles only with fresh rice and purified water, <br/>
								without chemical additives.<br/>
								<br/>
								Experience healthy and safe pho with your children and your family at PhoMein that serves the<br/>
								unprecedent noodles made with new crop rice of our exclusive technology. 
							</span>
						</div>
					</div>
					<div class="red02-wrap">
						<ul class="box">
							<li>
								...
								<div class="text_box">
									<p>FRESH</p>
									<span>The fragrance of freshly cooked rice using <br>freshly harvested new rice 365 days a year</span>
								</div>
							</li>
							<li>
								<div class="img_box">
								...
								<div class="text_box">
									<p>CLEAN</p>
									<span>The rice noodle contains clear and transparent  <br>color of new rice by only using clean <br>rice grain and purified water</span>
								</div>
							</li>
							<li>
								<div class="img_box">
								...
								<div class="text_box">
									<p>TECHNOLOGY</p>
									<span>The unique machine drying and<br>  low-temperature agingtechnology completes<br>  a soft and chewy texture. </span>
								</div>
							</li>
						</ul>
					</div>
					<div class="red03-wrap">
						<h2>
							PhoMein's "Noodle" is different,<br> it is a healthy “Freshly Harvested Rice Noodles"<br> made by PhoMein's own technology.
						</h2>
						<p>※ Freshly Harvested Rice Noodles are only used in PhoMein and PhoMein RED menus.</p>
					</div>
				</div>
			</div>
		</div>
