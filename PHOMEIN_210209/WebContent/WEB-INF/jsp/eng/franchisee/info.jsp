						...
						<fieldset>
							...
							<table class="view">
								...
								<tbody>
									...
									<tr>
										<th scope="row">STARTUP HOPE<br> AREA</th>
										<td>
											<input type="text" name="uparea" id="uparea" placeholder="STARTUP HOPE AREA" style="width:750px;">
										</td>
									</tr>
									<tr>
									...
									<tr>
										<th scope="row"><span class="need"></span> E-MAIL</th>
										<td>
...
$(function(){
	...
	var submitFunction = function (form) {
	    ...
	    $.ajax({
            url: "/eng/franchisee/info_modify.do",
            type: "POST",
            data: formdata,
            dataType: 'json',
            ...
            success: function (data) {
            	...
            	if(!!data.result) {
            		if(data.result == 'SUCCESS') {
            			...
            			location.href="/eng/franchisee/terms.do";
            		}
            	}
