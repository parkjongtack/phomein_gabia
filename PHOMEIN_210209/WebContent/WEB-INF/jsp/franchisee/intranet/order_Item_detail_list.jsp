...
<html lang="ko">
<head>
<title>본사 물품 신청 내역 목록 | 인트라넷 | 포메인 가맹점 관리</title>
					...
					<table class="list">
						...
						<c:choose>
							...
							<tr>
								...
								<td class="al-c"><a href="#"  onclick="javascript:fnDetailView('./order_item_detail_view.do', <c:out value="${result.seq }" />); return false;"  class="btn-link">${result.storename}</a></td>
								<%-- <td class="al-c"><a href="#" class="btn-link">항목 : ${result.gubun} 개<br>종류 : ${result.kind} 개</a></td> --%>
								<td class="al-c">
