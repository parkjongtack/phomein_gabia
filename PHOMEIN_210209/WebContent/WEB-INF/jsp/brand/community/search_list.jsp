			...
			<div class="inner">
				...
				<div class="search_list_box">
					...
					<div class="board_list board_notice">
						...
						<div class="more_box"><a href="/brand/community/notice/community_list.do?searchKeywordTemp=${param.search_key}" target="_blank">더보기</a></div>
						</c:if>
						<ul>
							<c:choose>
					...
					<div class="board_list board_store">
						...
						<div class="more_box"><a href="/brand/store/store_list.do?storeName=${param.search_key}" target="_blank">더보기</a></div>
						</c:if>
						<ul>
							<c:choose>
