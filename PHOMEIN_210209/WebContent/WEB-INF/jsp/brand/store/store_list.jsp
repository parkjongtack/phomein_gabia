			...
			<div class="map-wrap" center center no-repeat;background-size:cover"> <!-- style="background:url(../images/tmp/@map.jpg); -->
				...
				<div id="map">
					<div class="map-search-box">
						<h3 class="h3-type">매장찾기</h3>
						<div class="map-tab tabArea">
							<ul class="tab">
								<li class="active"><a href="#">매장명</a></li>
								<li id="addrLi"><a href="#">주소</a></li>
								<li id="optLi"><a href="#">옵션 선택</a></li>
							</ul>
							<!-- 매장명 -->
							<div class="tap-con on">
								...
								<div class="sch-input">
									<fieldset>
										...
										<input type="text" name="searchStoreName" id="searchStoreName" placeholder="매장명을 입력해주세요." title="매장명 입력" value="${storeName }" onkeypress="if(event.keyCode==13) {searchStoreNameBtn();}">
								...
								<div class="store-list">
									<div class="result">
										<a href="javascript:void(0)" onclick="searchStoreNameHiddenBtn();" class="btn-sch">재검색</a>
							...
							<div class="tap-con">
								...
								<div class="sch-input">
									<fieldset>
										...
										<input type="text" name="searchAddr" id="searchAddr" placeholder="주소를 입력해주세요." title="주소를 입력" onkeypress="if(event.keyCode==13) {searchAddrBtn();}">
								...
								<div class="store-list">
									<div class="result">
										<a href="javascript:void(0)" onclick="searchAddrHiddenBtn();" class="btn-sch">재검색</a>
										<span>검색 결과 <em id="totalAddrCnt">0</em>건</span>
									</div>
							...
							<div class="tap-con">
								...
								<div class="store-list">
									<div class="result">
										<a href="javascript:void(0);"  onclick="searchOptBtn();" class="btn-sch">재검색</a>
										<span>검색 결과 <em id="totalOptCnt">0</em>건</span>
									</div>
				...
				<script>
					...
					function initDaumApi(storeId , mapX , mapY){
					    ...
					    daum.maps.event.addListener(marker, 'click', function() {
					    	...
					    	$("#layerPopStore").load("/brand/store/store_view.do?seq="+storeId );
