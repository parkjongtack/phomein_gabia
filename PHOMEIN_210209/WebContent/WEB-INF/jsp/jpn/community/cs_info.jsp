...
<div id="wrap">
	...
	<section id="dBody" class="cs_center">
		...
		<div class="page-title">
			...
			<h2 class="h2-type">顧客問い合わせ</h2>
			<span class="txt">お客様のご質問に迅速にお答えできるよう、常に準備に万全を期しています。</span>
		</div>
		<!-- //page-title -->
									...
									<tr>
										...
										<td>
											<div class="file-box" style="width:750px;">
												...
												<button type="button" onclick="deleteImgFileText(this,'f_file1')" class="del">ファイル削除</button>
												<label for="uploadBtn" class="btn btn-03 type-02">探してみること</label>
											</div>
...
$(function(){
	...
	var submitFunction = function (form) {
	    ...
	    $.ajax({
            url: "/jpn/community/cs_center_modify.do",
            type: "POST",
            data: formdata,
            ...
            success: function (data) {
            	...
            	if(!!data.result) {
            		if(data.result == 'SUCCESS') {
            			alert('登録されました');
            			location.href="/jpn/community/cs_terms.do";
            		}
            	}
