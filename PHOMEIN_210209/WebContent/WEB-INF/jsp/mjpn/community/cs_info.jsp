	...
	<div id="container">
		...
		<div id="content" class="community">
			...
			<div class="write_area">
				...
				<table class="table_write">
						...
						<tbody>
							...
							<tr>
								...
								<td><textarea name="conts" id="conts" class="text" cols="30" rows="5" placeholder="内容" title="내용"></textarea></td>
							</tr>
							<tr>
				...
				<!-- 버튼 영역 -->
				<div class="btn_area">
					<a href="javascript:;" class="btn_tyf c_black" id="submitBtn">貯蔵</a>
				</div>
				<!-- //버튼 영역 -->
			</div>
			<!-- //등록 영역 -->
...
$(function(){
	...
	var submitFunction = function (form) {
	    ...
	    $.ajax({
            url: "/mjpn/community/cs_center_modify.do",
            type: "POST",
            data: formdata,
            ...
            success: function (data) {
            	...
            	if(!!data.result) {
            		if(data.result == 'SUCCESS') {
            			alert('登録されました');
            			location.href="/mjpn/community/cs_terms.do";
            		}
            	}
