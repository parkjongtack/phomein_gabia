package com.main.web.brand.etc.web;
...
@Controller
@RequestMapping({ "/brand/etc/*", "/mbrand/etc/*" })
public class BrandEtcController {

	private final Logger logger = LoggerFactory.getLogger(getClass());

	private final String NAMESPACE = "brand/etc/";
	
	private final String M_NAMESPACE = "mbrand/etc/";
