package com.main.web.brand.menu.web;
...
@Controller
@RequestMapping({ "/brand/menu/*", "/mbrand/menu/*" })
public class BrandMenuController {

	private final Logger logger = LoggerFactory.getLogger(getClass());

	private final String NAMESPACE = "brand/menu/";

	private final String M_NAMESPACE = "mbrand/menu/";
	...
	public String menu_list(@RequestParam Map param,
		...
		codeVO.setCode("102");
		// 국문 메뉴 카테고리 조회
		model.addAttribute("krcodes", codeService.selectCodeSub(codeVO));
	...
	public @ResponseBody Map<String, Object> get_menu_view_ajax(@RequestParam Map param,
		...
		codeVO.setCode("102");
		// 국문 메뉴 카테고리 조회
		returnMap.put("krcodes", codeService.selectCodeSub(codeVO));
		...
		String[] kr_menu_ck = { (String) map.get("kr_code") };
		param.put("menu_ck", kr_menu_ck);
		param.put("search_site_ck", 1);

		resultList.addAll(productService.selectCodeList(param));
		returnMap.put("krmenuList", resultList);
	...
	public String red_menu_list(@RequestParam Map param,
		...
		codeVO.setCode("118");
		// 국문 메뉴 카테고리 조회
		model.addAttribute("krcodes", codeService.selectRedCodeSub(codeVO));
	...
	public @ResponseBody Map<String, Object> get_red_menu_view_ajax(@RequestParam Map param,
		...
		codeVO.setCode("118");
		// 국문 메뉴 카테고리 조회
		returnMap.put("krcodes", codeService.selectRedCodeSub(codeVO));
System.out.println(">>>>>>>>>>>>> " + codeService.selectRedCodeSub(codeVO));
