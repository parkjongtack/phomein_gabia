package com.main.web.brand.store.web;
...
@Controller
@RequestMapping({ "/brand/store/*", "/mbrand/store/*" })
public class BrandStoreController {

	private final Logger logger = LoggerFactory.getLogger(getClass());

	private final String NAMESPACE = "brand/store/";

	private final String M_NAMESPACE = "mbrand/store/";
