package com.main.web.eng.phomein.web;
...
@Controller
@RequestMapping({ "/eng/phomein/*", "/meng/phomein/*" })
public class EngPhomeinController {

	private final Logger logger = LoggerFactory.getLogger(getClass());

	private final String NAMESPACE = "eng/phomein/";

	private final String M_NAMESPACE = "meng/phomein/";
