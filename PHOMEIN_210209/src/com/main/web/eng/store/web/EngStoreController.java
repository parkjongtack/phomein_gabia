package com.main.web.eng.store.web;
...
@Controller
@RequestMapping({ "/eng/store/*", "/meng/store/*" })
public class EngStoreController {
	
	private final Logger logger = LoggerFactory.getLogger(getClass());

	private final String NAMESPACE = "eng/store/";

	private final String M_NAMESPACE = "meng/store/";
