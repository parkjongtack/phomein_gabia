package com.main.web.eng.main.web;
...
@Controller
@RequestMapping({ "/eng/main/*", "/meng/main/*" })
public class EngController {

	private final Logger logger = LoggerFactory.getLogger(getClass());

	private final String NAMESPACE = "eng/main/";

	private final String M_NAMESPACE = "meng/main/";
	...
	// TODO /eng/community/{boardType}/community_list.do
