package com.main.web.eng.franchisee.web;
...
@Controller
@RequestMapping({ "/eng/franchisee/*", "/meng/franchisee/*" })
public class EngFranchiseeController {

	private final Logger logger = LoggerFactory.getLogger(getClass());

	private final String NAMESPACE = "eng/franchisee/";

	private final String M_NAMESPACE = "meng/franchisee/";
	...
	public String info(@RequestParam Map param, HttpSession session, ModelMap model, HttpServletRequest request,
		...
		if(!deviceType.equals("normal")){
			if (StringUtils.isEmpty(chk)) {
				return "redirect:/meng/franchisee/terms.do";
			}
		}

		if (StringUtils.isEmpty(chk)) {
			return "redirect:/eng/franchisee/terms.do";
		}
