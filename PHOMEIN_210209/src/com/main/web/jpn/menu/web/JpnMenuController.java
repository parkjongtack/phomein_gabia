package com.main.web.jpn.menu.web;
...
@Controller
@RequestMapping({ "/jpn/menu/*", "/mjpn/menu/*" })
public class JpnMenuController {

	private final Logger logger = LoggerFactory.getLogger(getClass());

	private final String NAMESPACE = "jpn/menu/";

	private final String M_NAMESPACE = "mjpn/menu/";
	...
	public String menu_list(@RequestParam Map param,
		...
		codeVO.setCode("104");
		// 일문 메뉴 카테고리 조회
		model.addAttribute("jpcodes", codeService.selectCodeSub(codeVO));
	...
	public @ResponseBody Map<String, Object> get_menu_view_ajax(@RequestParam Map param,
		...
		codeVO.setCode("104");
		// 일문 메뉴 카테고리 조회
		returnMap.put("jpcodes", codeService.selectCodeSub(codeVO));
		...
		String[] jp_menu_ck = { (String) map.get("jp_code") };
		param.put("menu_ck", jp_menu_ck);
		param.put("search_site_ck", 3);

		resultList.addAll(productService.selectCodeList(param));
		returnMap.put("jpmenuList", resultList);
	...
	public String red_menu_list(@RequestParam Map param,
		...
		codeVO.setCode("117");
		// 일문 메뉴 카테고리 조회
		model.addAttribute("jpcodes", codeService.selectRedCodeSub(codeVO));
	...
	public @ResponseBody Map<String, Object> get_red_menu_list_ajax(@RequestParam Map param,
		...
		System.out.println("PPPPPPPPPPPPPP: " + param);
		param.put("pageUnit", 9999);
		param.put("startCount", 0);
	...
	public @ResponseBody Map<String, Object> get_red_menu_view_ajax(@RequestParam Map param,
		...
		codeVO.setCode("117");
		// 일문 메뉴 카테고리 조회
		returnMap.put("jpcodes", codeService.selectRedCodeSub(codeVO));
