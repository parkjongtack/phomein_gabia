package com.main.web.jpn.community.web;
...
@Controller
@RequestMapping({ "/jpn/community/*", "/mjpn/community/*" })
public class JpnCommunityController {

	private final Logger logger = LoggerFactory.getLogger(getClass());

	private final String NAMESPACE = "jpn/community/";

	private final String M_NAMESPACE = "mjpn/community/";
	...
	public String cs_info(@RequestParam Map param, HttpSession session, ModelMap model, HttpServletRequest request,
		...
		if (!StringUtils.equals("normal", deviceType)) {
			if (StringUtils.isEmpty(chk)) {
				return "redirect:/mjpn/community/cs_terms.do";
			}
		}

		if (StringUtils.isEmpty(chk)) {
			return "redirect:/jpn/community/cs_terms.do";
		}
	...
	// TODO /brand/community/{boardType}/community_list.do
		...
		public String community_list(
			...
			String nameSpace = "jpn/community/";
			if (!StringUtils.equals("normal", deviceType)) {
				nameSpace = "mjpn/community/";
			}
